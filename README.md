...
A dark-mode TV guide web app with a classic EPG grid layout, supporting 8 regions and 100+ channels.
...
- **Progress bar** — Shows how far into the current broadcast you are
- **Real-time clock** — Header updates every second; local time per region shown
...
Single-file HTML/CSS/JS. Zero dependencies. Works offline.
